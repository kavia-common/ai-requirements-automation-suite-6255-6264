...
echo ""
echo "IMPORTANT:"
echo "- Schema is managed by the backend via SQLAlchemy models/migrations."
echo "- Ensure the backend sets MYSQL_URL, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB, MYSQL_PORT."
echo "- On backend startup, it should auto-create the required tables:"
echo "  jobs, requirements, artifacts, runs, run_steps, reports"
echo ""
echo "MySQL is running in the background."
echo "You can now start your application (backend will handle schema creation)."
